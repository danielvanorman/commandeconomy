...
public class AIHandler extends TimerTask {
   ...
   private static void loadPrivate() {
      ...
      if (!fileAIProfessions.isFile()) {
         ...
         Config.userInterface.printErrorToConsole(StringTable.WARN_FILE_MISSING + Config.filenameAIProfessions +
      ...
      try {
         ...
         Config.userInterface.printErrorToConsole(StringTable.ERROR_AI_MISFORMAT + Config.filenameAIProfessions);
      }
      catch (Exception e) {
         professions = null; // disable AI
         Config.userInterface.printErrorToConsole(StringTable.ERROR_AI_PARSING + Config.filenameAIProfessions);
         e.printStackTrace();
      }
      ...
      if (professions == null || professions.isEmpty()) {
         ...
         Config.userInterface.printErrorToConsole(StringTable.WARN_AI_NONE_LOADED);
         return;
      }
      ...
      if (professions.isEmpty()) {
         professions = null; // disable AI
         Config.userInterface.printErrorToConsole(StringTable.WARN_AI_INVALID);
         return;
      }
      ...
      if (Config.activeAI != null) {
         ...
         for (String aiProfession : Config.activeAI) {
            ...
            // warn the server
               ...
               Config.userInterface.printErrorToConsole(StringTable.ERROR_AI_MISSING + aiProfession);
         }
