...
public class CommandPrintMarket extends CommandBase {
   private final List<String> aliases = Arrays.asList(StringTable.CMD_PRINT_MARKET_LOWER);
  ...
  public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
      ...
      message = new TextComponentString(StringTable.MSG_PRINT_MARKET);
      sender.sendMessage(message);
  }

  @Override
  public String getName() {
      return StringTable.CMD_PRINT_MARKET;
  }
  ...
  public String getUsage(ICommandSender sender) {
      return StringTable.CMD_USAGE_PRINT_MARKET;
  }
