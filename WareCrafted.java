...
/**
 * A ware representing a product created with skill from other wares.
 *
 * @author  Daniel Van Orman
 * @version %I%, %G%
 * @since   2021-02-04
 */
public class WareCrafted extends Ware
{
   /**
    * Crafted Ware Constructor: Creates a ware
    * representing a product created from other wares.
    *
    ...
    */
   public WareCrafted (String[] components, String wareID, String alias, int quantity, int yield, byte level) {
      this.wareID   = wareID;
      setAlias(alias);
      priceBase     = Float.NaN;
   ...
   /** Crafted Ware Constructor: No-arguments for GSON. */
   public WareCrafted () {
      // default values
      yield    = 1;
   }
    ...
    * price is adjusted by the crafting multiplier.
