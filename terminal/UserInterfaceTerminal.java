...
public class UserInterfaceTerminal implements UserInterface
{
   ...
   protected static void registerCommands() {
      ...
      serviceableCommands.put(CommandEconomy.CMD_REVOKE_ACCESS, revokeAccess);
      serviceableCommands.put(CommandEconomy.CMD_REVOKE_ACCESS_LOWER, revokeAccess);
      ...
      serviceableCommands.put(CommandEconomy.CMD_CHANGE_STOCK, changeStock);
      serviceableCommands.put(CommandEconomy.CMD_CHANGE_STOCK_LOWER, changeStock);

      serviceableCommands.put(CommandEconomy.CMD_SET_DEFAULT_ACCOUNT, setDefaultAccount);
      serviceableCommands.put(CommandEconomy.CMD_SET_DEFAULT_ACCOUNT_LOWER, setDefaultAccount);

      serviceableCommands.put(CommandEconomy.CMD_PRINT_MARKET, printMarket);
      serviceableCommands.put(CommandEconomy.CMD_PRINT_MARKET_LOWER, printMarket);
